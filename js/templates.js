  ...
  vidaPregressa: {
    ...
    fields: [
      { id: 'genero', label: 'Gênero do(a) conduzido(a)', type: 'select',
        options: [{ value: 'M', label: 'Masculino' }, { value: 'F', label: 'Feminino' }] },
      { id: 'filhoLegitimo',   label: 'É filho legítimo?',                                      placeholder: 'Ex: sim / nao' },
      { id: 'teveTutores',     label: 'Teve tutores?',                                          placeholder: 'Ex: sim / nao' },
      { id: 'viveuCompanhia',  label: 'Viveu em sua companhia?',                                placeholder: 'Ex: sim / nao' },
      { id: 'escolas',         label: 'Frequentou escolas?',                                    placeholder: 'Ex: sim, quinta serie / nao' },
      { id: 'toxicos',         label: 'Dá-se ao uso de bebidas alcoólicas ou outros tóxicos?', placeholder: 'Ex: sim, crack / nao' },
      { id: 'internado',       label: 'Já esteve internado em casa de tratamento de moléstias mentais ou congêneres?', placeholder: 'Ex: sim / nao' },
      { id: 'internacaoQuandoQual', label: 'Quais e quando? (internação)',              placeholder: 'Ex: prej / Hospital X em 2020' },
      { id: 'estadoCivil',     label: 'É casado, divorciado, separado ou unido estávelmente?', placeholder: 'Ex: nao / casado / divorciado' },
      { id: 'vidaConjugal',    label: 'É harmônica ou não a vida conjugal?',       placeholder: 'Ex: prej / sim / nao' },
      { id: 'temFilhos',       label: 'Tem filhos?',                                            placeholder: 'Ex: sim / nao' },
      { id: 'quantosFilhos',   label: 'Quantos e idade?',                                      placeholder: 'Ex: prej / 2, sendo um de 3 e outro de 7 anos' },
      { id: 'filhosDeficiencia', label: 'O(s) filho(s) possui(em) algum tipo de deficiência?', placeholder: 'Ex: prej / nao / sim' },
      { id: 'responsavelFilhos', label: 'Quem é o responsável pelo(s) filho(s)?',    placeholder: 'Ex: prej / a mae / o pai' },
      { id: 'ondeReside',      label: 'Onde reside?',                                          placeholder: 'Ex: aluguel / casa propria / com familiares' },
      { id: 'habitacaoColetiva', label: 'Trata-se de habitação coletiva?',            placeholder: 'Ex: nao / sim' },
      { id: 'ondeTrabalha',    label: 'Onde trabalha?',                                        placeholder: 'Ex: prej / nome da empresa / reciclagem' },
      { id: 'ocupacao',        label: 'Qual a ocupação que exerce?',                 placeholder: 'Ex: desempregado / pedreiro / vendedor' },
      { id: 'bensImoveis',     label: 'Possui bens imóveis?',                             placeholder: 'Ex: nao / sim' },
      { id: 'bensImoveisQtd',  label: 'Quantos e qual o valor?',                               placeholder: 'Ex: prej / 1, avaliado em R$ 200.000' },
      { id: 'depositos',       label: 'Possui depósito em bancos, caixas econômicas, apólices?', placeholder: 'Ex: nao / sim' },
      { id: 'salario',         label: 'Se trabalha, quanto ganha?',                            placeholder: 'Ex: prej / R$ 1.500,00 mensais' },
      { id: 'desocupadoPorque', label: 'Se é desocupado, por quê?',                  placeholder: 'Ex: prej / foi demitido / nunca trabalhou' },
      { id: 'recebeAjuda',     label: 'Recebe ajuda de parentes, particulares ou instituições beneficentes?', placeholder: 'Ex: nao / sim, da mae' },
    ...
    generate: function(f) {
      ...
      // Helper: wrap answer in bold uppercase, fallback to bold [...]
      function R(val) {
        var v = (val || '').trim();
        return v ? '<strong>' + v.toUpperCase() + '</strong>' : '<strong>[...]</strong>';
      }

      var partes = [
        'Após, em obediência ao art. 6°, IX, do Código de Processo Penal, passou a autoridade a consignar elementos sobre a <strong>VIDA PREGRESSA</strong> ' + cond + ', nos seguintes termos: ',
