...
function generateTemplate() {
  ...
  var gtEl = document.getElementById('generatedText');
  if (tmpl.renderAsHtml) {
    gtEl.innerHTML = text;
  } else {
...
function copyGenerated() {
  const gtEl2 = document.getElementById('generatedText');
  const text = gtEl2.innerText || gtEl2.textContent;
