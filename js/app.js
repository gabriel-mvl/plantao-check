...
<body class="app-page" data-theme="dark">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <p class="nav-label">Ocorr&#234;ncias</p>
      <ul id="navList"></ul>
      <p class="nav-label" style="margin-top:1.4rem">Ferramentas</p>
      <ul>
        <li><a href="#" class="nav-link" onclick="openHistorico()"><span class="nav-icon">&#128337;</span> Hist&#243;rico</a></li>
        ...
        <li><a href="#" class="nav-link" onclick="PCDoc.open('autorizacaoSangue')"><span class="nav-icon">&#129656;</span> Autoriza&#231;&#227;o Sangue</a></li>
        <li><a href="#" class="nav-link" onclick="PCDoc.open('autorizacaoCelular')"><span class="nav-icon">&#128241;</span> Autoriza&#231;&#227;o Celular</a></li>
        <li><a href="#" class="nav-link" onclick="PCDoc.open('autorizacaoEntrada')"><span class="nav-icon">&#127968;</span> Autoriza&#231;&#227;o Entrada</a></li>
      </ul>
      <p class="nav-label" style="margin-top:1.4rem">Refer&#234;ncias</p>
      <ul>
        <li><a href="#" class="nav-link" onclick="openRef('requisicoes')"><span class="nav-icon">&#128203;</span> Requisi&#231;&#245;es IML/IC</a></li>
        <li><a href="#" class="nav-link" onclick="openRef('orientacoes')"><span class="nav-icon">&#128204;</span> Orienta&#231;&#245;es Gerais</a></li>
  ...
  <main class="main-content" id="mainContent">
    ...
    <header class="topbar">
      ...
      <div class="topbar-title" id="topbarTitle">Selecione uma ocorr&#234;ncia</div>
      <div class="sync-indicator hidden" id="syncIndicator" title="Sincronizando...">&#9729;</div>
      <div class="topbar-actions">
        <button class="btn-icon" onclick="window.print()" title="Imprimir">&#128424;</button>
        <button class="btn-icon" onclick="generatePDF()" title="Gerar PDF">&#128196;</button>
      </div>
    </header>
    ...
    <div class="home-view" id="homeView">
      ...
      <div class="home-layout">
        ...
        <!-- COLUNA ESQUERDA: checklists -->
        <div class="home-col-main">
          <div class="home-module">
            <div class="home-module-header">
              <div class="home-module-icon">&#9989;</div>
              <div>
                <div class="home-module-title">Ocorr&#234;ncias</div>
                <div class="home-module-sub">Abra o checklist da ocorr&#234;ncia em andamento</div>
              </div>
              <button class="btn-plantao-diario" onclick="openPlantaoDiario()" style="margin-left:auto;white-space:nowrap;flex-shrink:0">
                &#9200; Rotina
              </button>
            </div>
            <div class="home-search-wrap" style="margin:0 0 .75rem">
              <input class="home-search" id="homeSearch" type="text"
                     placeholder="&#128269; Buscar tipo de ocorr&#234;ncia..."
                     oninput="filterOccurrences()" autocomplete="off"
                     style="max-width:100%" />
            </div>
            <div class="occurrence-grid" id="occurrenceGrid"></div>
            <p class="no-results hidden" id="noResults">Nenhuma ocorr&#234;ncia encontrada.</p>
          </div>
        </div>

        <!-- COLUNA DIREITA: ferramentas + documentos -->
        <div class="home-col-side">
          ...
          <div class="home-module">
            <div class="home-module-header">
              <div class="home-module-icon">&#128295;</div>
              <div>
                <div class="home-module-title">Ferramentas</div>
                <div class="home-module-sub">Consulta r&#225;pida durante o plant&#227;o</div>
              </div>
            </div>
            <div class="home-tools-grid home-tools-grid-2col">
              <button class="home-tool-card" onclick="openHistorico()">
                <span class="home-tool-icon">&#128337;</span>
                <span class="home-tool-name">Hist&#243;rico</span>
                <span class="home-tool-desc">Veja e gerencie ocorr&#234;ncias j&#225; registradas</span>
              </button>
              <button class="home-tool-card" onclick="openRelatorio()">
                <span class="home-tool-icon">&#128196;</span>
                <span class="home-tool-name">Relat&#243;rio do Plant&#227;o</span>
                <span class="home-tool-desc">Resumo imprim&#237;vel de todos os BOs do turno</span>
              </button>
              <button class="home-tool-card" onclick="openEmailMenu()">
                <span class="home-tool-icon">&#128231;</span>
                <span class="home-tool-name">Modelos de E-mail</span>
                <span class="home-tool-desc">Preencha e copie comunicados oficiais</span>
              </button>
              <button class="home-tool-card" onclick="openArtigosMenu()">
                <span class="home-tool-icon">&#9878;</span>
                <span class="home-tool-name">Legisla&#231;&#227;o</span>
                <span class="home-tool-desc">Artigos do CP, CPP e leis extravagantes</span>
              </button>
              <button class="home-tool-card" onclick="openQuesitosMenu()">
                <span class="home-tool-icon">&#128203;</span>
                <span class="home-tool-name">Quesitos Periciais</span>
                <span class="home-tool-desc">Manual oficial da PCSP por tipo de crime</span>
              </button>
              <button class="home-tool-card" onclick="window.open('pre-atendimento.html','_blank')">
                <span class="home-tool-icon">&#128221;</span>
                <span class="home-tool-name">Pr&#233;-Atendimento</span>
                <span class="home-tool-desc">Ficha para espontaneamente apresentados</span>
              </button>
            </div>
          </div>
          ...
          <div class="home-module">
            <div class="home-module-header">
              <div class="home-module-icon">&#128196;</div>
              <div>
                <div class="home-module-title">Documentos Oficiais</div>
                <div class="home-module-sub">Gere com cabe&#231;alho e rodap&#233; da sua unidade</div>
              </div>
            </div>
            <div class="home-tools-grid home-tools-grid-2col">
              <button class="home-tool-card" onclick="PCDoc.open('autorizacaoSangue')">
                <span class="home-tool-icon">&#129656;</span>
                <span class="home-tool-name">Coleta de Sangue</span>
                <span class="home-tool-desc">Autoriza&#231;&#227;o — Resolu&#231;&#227;o CONTRAN 432/2013</span>
              </button>
              <button class="home-tool-card" onclick="PCDoc.open('autorizacaoCelular')">
                <span class="home-tool-icon">&#128241;</span>
                <span class="home-tool-name">Extra&#231;&#227;o de Celular</span>
                <span class="home-tool-desc">Autoriza&#231;&#227;o de acesso e c&#243;pia de dados</span>
              </button>
              <button class="home-tool-card" onclick="PCDoc.open('autorizacaoEntrada')">
                <span class="home-tool-icon">&#127968;</span>
                <span class="home-tool-name">Entrada em Resid&#234;ncia</span>
                <span class="home-tool-desc">Consentimento — art. 5&#186; XI CF + HC 598.051/STJ</span>
              </button>
            </div>
          </div>
  ...
  <div class="modal-backdrop" id="plantaoInicioBackdrop"></div>
  <div class="modal" id="plantaoInicioModal" style="max-width:460px">
    <div class="modal-header">
      <div>
        <h3>Abrir Plant&#227;o</h3>
    ...
    <div class="modal-body">
      ...
      <div class="modal-form-group">
        ...
        <input type="text" id="plantaoDelegacia" placeholder="Ex: 1ª DP de Sorocaba" />
      </div>
      <div class="modal-form-group">
        <label>Delegado plantonista</label>
        <input type="text" id="plantaoDelegado" placeholder="Nome do delegado" />
      </div>
