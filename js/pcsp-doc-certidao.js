...
PCSP_DOCS.certidao = {
  ...
  gerar: function(campos, u) {
    ...
    switch (tipo) {
      case 'recusa_interr':
        corpo_texto =
          'o(a) indiciado(a) <strong>' + nome + '</strong>, devidamente qualificado(a) nos autos, ' +
      ...
      case 'recusa_dactilo':
        corpo_texto =
          ...
          'impress\u00f5es datiloscópicas para fins de legitima\u00e7\u00e3o dos atos praticados, ' +
          'o que fa\u00e7o constar para os devidos fins legais.';
        break;

      case 'recusa_tco':
        corpo_texto =
          'o(a) autor(a) do fato <strong>' + nome + '</strong>, devidamente qualificado(a) nos autos, ' +
